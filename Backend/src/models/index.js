...
module.exports = {
  ...
  SavingsGoal:      require('./savingsGoal.model'),
  LearnProgress:    require('./learnProgress.model'),
  UserPreferences:  require('./userPreferences.model'),
  QueuedPayment:    require('./queuedPayment.model'),
};
